...
interface RevokeLinkConfirmationModalProps {
  isVisible: boolean
  onClose: () => void
  onConfirm: () => void
}

const RevokeLinkConfirmationModal = ({ isVisible, onClose, onConfirm }: RevokeLinkConfirmationModalProps) => {
  useEffect(() => {
    if (isVisible) {
    ...
    >
      ...
      >
        <div className='col-flex gap-2 text-center'>
          <span>Are you sure you want to revoke this share link?</span>
        </div>
...
export default RevokeLinkConfirmationModal
